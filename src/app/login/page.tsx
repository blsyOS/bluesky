    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-gradient-to-b from-background to-surface-muted px-4">
      ...
      <Card variant="elevated" className="w-full max-w-sm">
        <CardBody className="space-y-4 p-6">
          ...
          <Link
            href="/dashboard"
            className="flex h-9 w-full items-center justify-center rounded-lg bg-primary text-sm font-medium text-primary-foreground shadow-card transition-colors hover:bg-primary-hover"
          >
            Sign in
          </Link>
          <HelperText>
