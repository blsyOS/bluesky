...
const PAGE_ENTRIES: Array<Omit<SearchResult, "categoryId" | "score">> = [
  ...
  },
  {
    id: "page-locations",
    title: "Locations",
    description: "Physical operating locations for your organization",
    href: "/locations",
    icon: MapPinIcon,
    keywords: ["offices", "yards", "warehouses", "headquarters", "storm office"],
  },
  {
    id: "page-departments",
    title: "Departments",
    description: "How your organization is structured",
    href: "/departments",
    icon: SitemapIcon,
    keywords: ["operations", "dispatch", "safety", "org structure"],
  },
  {
    id: "page-teams",
    title: "Teams",
    description: "Crews and shifts inside your departments",
    href: "/teams",
    icon: TeamIcon,
    keywords: ["crews", "shifts", "units", "storm team"],
  },
  {
    id: "page-users",
    title: "Users",
